...
public class Constants {
    ...
    /**秒滴SMS start**/
    public static final String MDSMS_ACCOUNT_SID = "97429e59fa4e48b383c115d7a1416898";

    public static final String MDSMS_AUTH_TOKEN = "cdca6144851d4b81ba3bb158fd4d322c";

    public static final String MDSMS_REST_URL = "https://api.miaodiyun.com/20150822";

    public static final String MDSMS_VERCODE_TPLID = "1512158243";
